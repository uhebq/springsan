...
<head>
  ...
  <form name='signinForm'>
    ...
    <div class="form-floating">
      <input value="ksan0117@naver.com" type="text" class="form-control start" required="required" id="email" placeholder="email">
      <label for="email">Email</label>
    </div>
    <div class="form-floating">
      <input value="z9468557!!" type="password" class="form-control end" id="pw" placeholder="Password">
    ...
    <a href = "/recipe/findEmailForm">이메일 찾기</a>
